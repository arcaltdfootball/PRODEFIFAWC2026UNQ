...
if st.session_state["fase_resultados"] == "dieciseisavos":
    ...
    for c in cruces:
        nombre_local     = c.get("equipo_local") or c.get("placeholder_local")
        nombre_visitante = c.get("equipo_visitante") or c.get("placeholder_visitante")
        ...
        outer_card_16 = (
            ...
            + ('<br><span style="font-size:0.65rem;color:#64748b;">(' + c.get("placeholder_local","") + ')</span>' if not es_placeholder else '')
            + '</span></div>'
            ...
            + ('<br><span style="font-size:0.65rem;color:#64748b;">(' + c.get("placeholder_visitante","") + ')</span>' if not es_placeholder else '')
            + '</span></div>'
            '</div>'
            '</div>'
            '</div>'
