...
if st.session_state["fase_resultados"] == "dieciseisavos":
    ...
    for c in cruces:
        ...
        # OJO: solo lo mostramos si el resultado fue realmente cargado en el
        # admin (resultado_16 truthy); si no, aunque "marcador" tenga un valor
        # por defecto tipo "0-0" en la base, mostramos VS.
        gl_16, gv_16 = None, None
        if resultado_16 and marcador_16 and "-" in str(marcador_16):
