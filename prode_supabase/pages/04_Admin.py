...
if cruces_16:
    for c in cruces_16:
        ...
        # Parsear marcador guardado en goles_local / goles_visitante
        ...
        with col3:
            # En eliminación directa no hay empate: 1 = gana local, 2 = gana visitante
            opciones_16 = ["", "1", "2"]
            if gl_input_16 > gv_input_16:
                ...
                sugerido_16 = resultado_actual_16
