...
# La tabla "partidos" no tiene columna de fase/ronda, así que se identifica
# por rango de partido_num: 89 a 96 (8 partidos) = Dieciseisavos de Final.
DIECISEISAVOS_MIN = 89
DIECISEISAVOS_MAX = 96

resp_partidos_16 = (
    sb.table("partidos")
    .select("id, resultado")
    .gte("partido_num", DIECISEISAVOS_MIN)
    .lte("partido_num", DIECISEISAVOS_MAX)
    .execute()
)
