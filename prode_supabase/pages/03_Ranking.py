...
ranking_16 = sorted(ranking, key=lambda x: x["pts_dieciseisavos"], reverse=True)
# Reemplazar "puntos" y "aciertos/disputados" con los de 8vos para la columna de pts
ranking_16_adj = []
for r in ranking_16:
    r2 = dict(r)
    r2["puntos"]     = r["pts_dieciseisavos"]
    r2["aciertos"]   = r["ac_dieciseisavos"]
    r2["disputados"] = r["dis_dieciseisavos"]
...
# ── Tabs ──────────────────────────────────────────────────────────────────────
tab_general, tab_16 = st.tabs(["🏆  Ranking General", "⚔️  Octavos de Final"])
