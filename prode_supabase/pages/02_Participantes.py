...
for numero, p in enumerate(participantes_filtrados, start=1):
    ...
    if expandido:
        ...
        # ══════════════════════════════════════════════════════════════════
        if st.session_state[key_fase] == "dieciseisavos":
            ...
            if not cruces_16:
                ...
                st.markdown(
                    ...
                    '<div class="card-partido-meta">🏆 Cruce ' + str(c_actual.get("partido_num")) + '</div>'
        ...
        # ══════════════════════════════════════════════════════════════════
        # BOLETA — FASE DE GRUPOS (comportamiento original)
        # ══════════════════════════════════════════════════════════════════
        elif not todos_partidos:
            ...
            # ── Selector directo de partido (grilla de botones numerados) ──
            ...
            if goles_local_guardado is not None and goles_visit_guardado is not None:
                ...
                # Recuadros con marcador guardado
                score_html = (
                    '<div class="score-box-wrap">'
            ...
            # ── Card del partido con marcador integrado ────────────────────────
            st.markdown(
                '<div class="card-partido">'
            ...
            # ── Inputs de marcador — si tiene permiso ─────────────────────────
            if editable:
                st.markdown('<div style="height:6px;"></div>', unsafe_allow_html=True)
                ...
                # Inicializar session_state con valor guardado
                ...
                # Actualizar si cambió el partido
                ...
                with col_guardar_m:
                    ...
                    if st.button(lbl_btn, key="save_m_" + str(p_id) + "_" + str(partido_id),
                        ...
                        if guardar_pron(p_id, partido_id, marcador_nuevo):
