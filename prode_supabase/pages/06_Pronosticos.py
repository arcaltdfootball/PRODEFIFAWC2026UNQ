...
# ── Índices ─────────────────────────────────────────────────────────────────────
# participante_id → nombre
part_nombre = {p["id"]: p["nombre"] for p in participantes_raw}
...
apuestas = pron_por_partido.get(p_id, {})
