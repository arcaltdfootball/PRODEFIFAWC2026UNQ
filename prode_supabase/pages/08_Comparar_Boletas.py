...
if st.session_state.get("cmp_activo"):
    ...
    st.markdown(
        ...
        f'<div class="num">{coinciden_n}</div>'
        '<div class="lbl">Coinciden</div>'
        '</div>'
        '<div class="resumen-box rojo">'
        f'<div class="num">{difieren_n}</div>'
        '<div class="lbl">Difieren</div>'
        '</div>'
        '<div class="resumen-box gris">'
        f'<div class="num">{sin_comparar_n}</div>'
        '<div class="lbl">Sin comparar</div>'
        '</div>'
        '</div>',
        unsafe_allow_html=True,
    )
    ...
    for p in lista_part_grupo:
        ...
        if v1 is not None and v2 is not None and v1 == v2:
            ...
            badge_match = '<span class="si">✓ Coinciden</span>'
        ...
        def pill_html(valor):
            if valor == "1":
                return f'<div class="comp-pill op1">1</div><div class="comp-sub">Gana {local}</div>'
            if valor == "X":
                return '<div class="comp-pill opX">X</div><div class="comp-sub">Empate</div>'
            if valor == "2":
                return f'<div class="comp-pill op2">2</div><div class="comp-sub">Gana {visitante}</div>'
