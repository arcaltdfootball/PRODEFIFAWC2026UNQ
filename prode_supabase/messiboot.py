...
def _groq_api_key() -> str:
    import os
    key = os.environ.get("GROQ_API_KEY", "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")
    if not key:
        try:
            key = st.secrets.get("GROQ_API_KEY", "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")
        except Exception:
            pass
    return key
